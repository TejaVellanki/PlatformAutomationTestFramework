    ...
    public class MopayBackup
    {
        ...
        public void Dsecure(IWebDriver driver, ISelenium selenium)
        {
            ...
            else
            {
                ...
                this.datarow.newrow("Checkout", "Server Error", actual, "FAIL", driver, selenium);
                new MoBankUI.Screenshot().screenshotfailed(driver, selenium);
        ...
        public void MoPay(IWebDriver driver, ISelenium selenium)
        {
            ...
            try
            {
                for (int i = 0; i < count; i++)
                {
                    ...
                    string str9 = driver.FindElement(By.XPath("//div[@id='TotalAmountControl']/div/input")).GetAttribute("Amt");
                    string str10 = driver.FindElement(By.XPath("//div[@id='CurrencyCodeControl']/div/select")).GetAttribute("Cur");
                    ...
                    for (int j = 0; j < num3; j++)
                    {
                        ...
                        switch (str2)
                        {
                            case "id=actionPay":
                                ...
                                selenium.Select("//div[@id='BillingContact.Address.CountryControl']/div/div/select", str24);
                                break;
                        ...
                        {
                            this.datarow.newrow("Card Number", str13, str13, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("Number required") || selenium.IsTextPresent("Number invalid"))
                        {
                            this.datarow.newrow("Card Number", str13, "Number Invalid", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Card Number", str13, "No Error Message Displayed", "FAIL", driver, selenium);
                        ...
                        {
                            this.datarow.newrow("Security Code", str14, "Valid 3 Digits", "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("Security code required") || selenium.IsTextPresent("Security code invalid"))
                        {
                            this.datarow.newrow("Security Code", str14, "Security code required", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Security Code", str14, "No Error Message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str16, "^[a-zA-Z'']"))
                        {
                            this.datarow.newrow("Name on Card", str16, str16, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("Name required"))
                        {
                            this.datarow.newrow("Name on Card", str16, "Name Required", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Name on Card", str16, "No Error Message Displayed", "PASS", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        ...
                        {
                            this.datarow.newrow("Last Name", str12, str12, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Last Name field is required."))
                        {
                            this.datarow.newrow("Last Name", str12, "The Last Name field is required.", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Last Name", str12, "No Error message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str20, "^[a-zA-Z0-9'']"))
                        {
                            this.datarow.newrow("Address", str20, str20, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Address field is required"))
                        {
                            this.datarow.newrow("Address", str20, "The Address field is required", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Address", str20, "No Error message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str22, "^[a-zA-Z0-9'']"))
                        {
                            this.datarow.newrow("Post Code", str22, str22, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Postcode field is required"))
                        {
                            this.datarow.newrow("Post Code", str22, "The Postcode field is required.", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Post Code", str22, "No Error Message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str24, "^[a-zA-Z'']"))
                        {
                            this.datarow.newrow("Country", str24, str24, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Country field is required."))
                        {
                            this.datarow.newrow("Country", str24, "The Country field is required.", "PASS", driver, selenium);
                        }
                        else
                        {
                            this.datarow.newrow("Country", str24, "No Error Message", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
