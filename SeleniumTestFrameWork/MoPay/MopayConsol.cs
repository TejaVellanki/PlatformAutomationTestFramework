    ...
    public class MopayConsol : driverdefining
    {
        ...
        public void HomepageTabs(IWebDriver driver)
        {
            ...
            try
            {
                ...
                {
                    datarow.newrow("HomeTitle", "Manage : mopowered.co.uk", actual, "PASS",driver);
                }
                else if ( driver.PageSource.Contains("Server Error in '/' Application."))
                {
                    datarow.newrow("HomeTitle", "Manage : mopowered.co.uk", "Server Error", "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                else
                {
                    datarow.newrow("HomeTitle", "Manage : mopowered.co.uk", actual, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                ...
                {
                    datarow.newrow("Accounts Title", "Accounts : mopowered.co.uk", str3, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Accounts Title", "Accounts : mopowered.co.uk", str3, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver);
                ...
                {
                    datarow.newrow("Providers Title", "Providers : mopowered.co.uk", str5, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Providers Title", "Providers : mopowered.co.uk", str5, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver );
                ...
                {
                    datarow.newrow("Card Type Title", "Card Types : mopowered.co.uk", str6, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Card Type Title", "Card Types : mopowered.co.uk", str6, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver );
                ...
                {
                    datarow.newrow("Objects Page Title", "Objects - : mopowered.co.uk", str10, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Objects Page Title", "Objects - : mopowered.co.uk", str10, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver);
                ...
                {
                    datarow.newrow("Security Page Title", "Title : mopowered.co.uk", str11, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Security Page Title", "Title : mopowered.co.uk", str11, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver );
                ...
                {
                    datarow.newrow("User Page Title", "Users : mopowered.co.uk", str12, "PASS",driver);
                }
                else
                {
                    datarow.newrow("User Page Title", "Users : mopowered.co.uk", str12, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver);
                ...
                {
                    datarow.newrow("Groups Page Title", "Groups : mopowered.co.uk", str13, "PASS",driver);
                }
                else
                {
                    datarow.newrow("Groups Page Title", "Groups : mopowered.co.uk", str13, "FAIL",driver);
                    screenshot.screenshotfailed(driver);
                    driver.Navigate().GoToUrl("https://devpay.mobankdev.com/Management");
                }
                Mopowered(driver );
                new mopayconsoleacctab().acctabs(driver, datarow);
            }
