        ...
        public void MoPay(IWebDriver driver, ISelenium selenium)
        {
            ...
            try
            {
                for (int i = 0; i < count; i++)
                {
                    ...
                    driver.FindElement(By.CssSelector("input[type=\"submit\"]")).Click();
                    datarow.newrow("Account", "Type", locator, "PASS", driver, selenium);
                    ...
                    for (int j = 0; j < num3; j++)
                    {
                        ...
                        {
                            datarow.newrow("Card Number", str15, str15, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("Number required") || selenium.IsTextPresent("Number invalid"))
                        {
                            datarow.newrow("Card Number", str15, "Number Invalid", "PASS", driver, selenium);
                        }
                        else
                        {
                            datarow.newrow("Card Number", str15, "No Error Message Displayed", "FAIL", driver, selenium);
                        ...
                        {
                            datarow.newrow("Security Code", str16, "Valid 3 Digits", "PASS", driver, selenium);
                        }
                        ...
                        {
                            datarow.newrow("Name on Card", str18, str18, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("Name required"))
                        {
                            datarow.newrow("Name on Card", str18, "Name Required", "PASS", driver, selenium);
                        }
                        else
                        {
                            datarow.newrow("Name on Card", str18, "No Error Message Displayed", "PASS", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        ...
                        {
                            datarow.newrow("Last Name", str14, str14, "PASS", driver, selenium);
                        }
                        ...
                        {
                            datarow.newrow("Last Name", str14, "No Error message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str22, "^[a-zA-Z0-9'']"))
                        {
                            datarow.newrow("Address", str22, str22, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Address field is required"))
                        {
                            datarow.newrow("Address", str22, "The Address field is required", "PASS", driver, selenium);
                        }
                        else
                        {
                            datarow.newrow("Address", str22, "No Error message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str24, "^[a-zA-Z0-9'']"))
                        {
                            datarow.newrow("Post Code", str24, str24, "PASS", driver, selenium);
                        }
                        ...
                        {
                            datarow.newrow("Post Code", str24, "No Error Message Displayed", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
                        if (Regex.IsMatch(str26, "^[a-zA-Z'']"))
                        {
                            datarow.newrow("Country", str26, str26, "PASS", driver, selenium);
                        }
                        else if (selenium.IsTextPresent("The Country field is required."))
                        {
                            datarow.newrow("Country", str26, "The Country field is required.", "PASS", driver, selenium);
                        }
                        else
                        {
                            datarow.newrow("Country", str26, "No Error Message", "FAIL", driver, selenium);
                            screenshot.screenshotfailed(driver, selenium);
                        }
            ...
            catch (Exception exception2)
            {
                ...
                datarow.newrow("Checkout", "Server Error", str28, "FAIL", driver, selenium);
