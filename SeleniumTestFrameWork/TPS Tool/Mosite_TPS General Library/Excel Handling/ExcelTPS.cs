...
namespace MoBankUI
{
    class GeneralLibrary
    {
        ...
        public DataSet GetExcelData(string excelFile, string sheetname)
        {
            ...
            OleDbCommand objCmdSelect = new OleDbCommand(sqlquery, objConn);
        ...
        public Workbook CreateAndOpenExcelFile(string filePath, ref string fileName, string sheetName,string extension, bool displayAlerts, bool appendDateField)
        {
            ...
            try
            {
                ...
                workbook.SaveAs(filePath + "\\" + fileName, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, XlSaveAsAccessMode.xlNoChange, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
                ...
                if (!String.IsNullOrEmpty(sheetName))
                {
                    ...
                    Worksheet reqSheetConsolidated = (Worksheet)sheets.get_Item(currentSheetCount);

                    Worksheet newSheetConsolidated = (Worksheet)sheets.Add(Type.Missing, reqSheetConsolidated, 1, Type.Missing);
                    ...
                    for (int sheetCount = 1; sheetCount <= workbook.Sheets.Count; sheetCount++)
                    {
                        ...
                        Worksheet verSheet = (Worksheet)workbook.Worksheets.get_Item(sheetCount);

                        if ("Sheet1" == verSheet.Name.ToString())
                        {
