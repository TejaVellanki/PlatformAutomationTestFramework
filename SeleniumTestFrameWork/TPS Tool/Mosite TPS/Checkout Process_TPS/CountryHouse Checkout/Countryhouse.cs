...
namespace MoBankUI
{
    class Countryhouse
    {
        public void checkoutprocess(IWebDriver driver, ISelenium selenium)
        {
            ...
            new SelectElement(driver.FindElement(By.XPath("//form[@id='ctl00']/section/div[4]/fieldset/div[2]/div/div/select"))).SelectByText("12 - Dec");
            new SelectElement(driver.FindElement(By.XPath("//form[@id='ctl00']/section/div[4]/fieldset/div[2]/div[2]/div/select"))).SelectByText("22");
            ...
            new SelectElement(driver.FindElement(By.XPath("//form[@id='ctl00']/section/div[6]/fieldset/div[2]/div/div/select"))).SelectByText("12 - Dec");
            driver.FindElement(By.XPath("//select[@id='Pagecontent_ddlStartMonth']/option[13]")).Click();
            new SelectElement(driver.FindElement(By.XPath("//form[@id='ctl00']/section/div[6]/fieldset/div[2]/div[2]/div/select"))).SelectByText("4");
