    ...
    internal class UserJourney
    {
            ...
            if (str.Contains("30"))
            {
                if (selenium.IsElementPresent("//form[@id='AddToBasketForm']/ul/li[2]/fieldset/div[2]/div/div/select"))
                {
                    new SelectElement(
                     ...
                     selenium.IsElementPresent("//form[@id='AddToBasketForm']/ul/li[2]/fieldset/div[2]/div/div/select"))
            {
                new SelectElement(
                    driver.FindElement(
                        By.XPath("//form[@id='AddToBasketForm']/ul/li[2]/fieldset/div[2]/div/div/select")))
        ...
        public void UserJourn(datarow datarow, IWebDriver driver, ISelenium selenium)
        {
            try
            {
                ...
                selenium.WaitForPageToLoad("30000");
                Thread.Sleep(3000);
                if (!selenium.IsElementPresent("//body[@id='page-basket-index']/div/div[2]/div/div[3]/a/span/span") ||
                ...
                {
                    productunavailabl(selenium, driver, l);
