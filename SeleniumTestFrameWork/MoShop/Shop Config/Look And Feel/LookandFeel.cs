...
namespace MoBankUI
{
    ...
    {
        public void lookandfeel(IWebDriver driver, ISelenium selenium, datarow datarow, string version)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (attriute == "QA-TestShop")
                    {
                        ...
                        new SelectElement(driver.FindElement(By.Id("ViewVersion"))).SelectByText(version);
