        ...
        public void Images(IWebDriver driver ,datarow datarow)
        {
            try
            {
               ...
               //Logo and Home Page Image
                driver.FindElement(By.Id("HomeImageImport_Image")).SendKeys(@"C:\Users\teja\Documents\GitHub\PlatformAutomationTestFramework\SeleniumTestFrameWork\ObjectRepository\Homepage and CategoryImages\Teja Home Image.jpg");
            Thread.Sleep(2000);
