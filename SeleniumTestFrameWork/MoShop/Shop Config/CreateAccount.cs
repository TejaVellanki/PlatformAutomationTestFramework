...
namespace MoBankUI
{
    ...
    {
        public void SeleniumShopAccount(IWebDriver driver, ISelenium selenium)
        {
            driver.FindElement(By.XPath("(//a[contains(text(),'Shops')])[2]")).Click();
            driver.FindElement(By.LinkText("Create")).Click();
            driver.FindElement(By.Id("Name")).Clear();
            driver.FindElement(By.Id("Name")).SendKeys("QA -SeleniumRegression");
            driver.FindElement(By.Id("Identifier")).Clear();
            driver.FindElement(By.Id("Identifier")).SendKeys("qaseleniumregression");
            ...
            driver.FindElement(By.Id("Customisations_0__Title")).SendKeys("QA-SeleniumRegression Customisations");
            ...
            driver.FindElement(By.Id("HomeImage_ImageUpload")).SendKeys(@"C:\Users\Teja\Desktop\Upload Themes and Logos\Modrophenia");
            driver.FindElement(By.Id("Icon_ImageUpload")).Clear();
            driver.FindElement(By.Id("Icon_ImageUpload")).SendKeys(@"C:\Users\Teja\Desktop\Upload Themes and Logos\Modrophenia Icon.ico");
            ...
            driver.FindElement(By.Id("ExternalLinks_0__LinkReplacement")).SendKeys("/pages/modropheniacom-in-mod-we-trust/288054451149");
            ...
            driver.FindElement(By.Id("OrderConfirmationSuccessImage_ImageUpload")).SendKeys(@"C:\Users\Teja\Desktop\Upload Themes and Logos\success.png");
            driver.FindElement(By.Id("OrderConfirmationFailureMessage")).Clear();
            driver.FindElement(By.Id("OrderConfirmationFailureMessage")).SendKeys("Sorry your order has not been successful.");
            driver.FindElement(By.Id("OrderConfirmationFailureImage_ImageUpload")).Clear();
            driver.FindElement(By.Id("OrderConfirmationFailureImage_ImageUpload")).SendKeys(@"C:\Users\Teja\Desktop\Upload Themes and Logos\Fail.png");
            driver.FindElement(By.CssSelector("input.button")).Click();
        }
    }
}
