...
namespace MoBankUI
{
    ...
    internal class Addressconfig
    {
        public void addressconfig(IWebDriver driver, ISelenium selenium, datarow datarow)
        {
            ...
            {
                datarow.newrow("Dynamic Source URL", "https://www.the-tickle-company.co.uk/cgi-bin/os000001.pl?ACTION=Start", attribute, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("Dynamic Source URL", "https://www.the-tickle-company.co.uk/cgi-bin/os000001.pl?ACTION=Start", attribute, "FAIL", driver, selenium);
            }
            if (actual == "https://www.the-tickle-company.co.uk/cgi-bin/os000001.pl")
            {
                datarow.newrow("URL", "https://www.the-tickle-company.co.uk/cgi-bin/os000001.pl", actual, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("URL", "https://www.the-tickle-company.co.uk/cgi-bin/os000001.pl", actual, "FAIL", driver, selenium);
            }
            ...
            if (str6 == "RANDOM=0.346205551018105&SEQUENCE=0&ActCheckoutPhase=INVOICE&ActCheckoutPhase=DELIVER&ActCheckoutPhase=PRELIM&INVOICENAME={{FirstName}}+{{LastName}}&DELIVERNAME={{FirstName}}+{{LastName}}&INVOICEPOSTALCODE={{INVOICEPOSTALCODE}}&DELIVERPOSTALCODE={{INVOICEPOSTALCODE}}&INVOICEADDRESS1={{INVOICEADDRESS1}}&DELIVERADDRESS1={{INVOICEADDRESS1}}&INVOICEADDRESS2={{INVOICEADDRESS2}}&DELIVERADDRESS2={{INVOICEADDRESS2}}&INVOICEADDRESS3={{INVOICEADDRESS3}}&DELIVERADDRESS3={{INVOICEADDRESS3}}&LocationInvoiceCountry={{INVOICECOUNTRY}}&INVOICECOUNTRY={{INVOICECOUNTRY}}&LocationDeliveryCountry={{INVOICECOUNTRY}}&LocationInvoiceRegion=UndefinedRegion&INVOICEADDRESS4={{INVOICEADDRESS4}}&LocationDeliveryRegion=UndefinedRegion&DELIVERADDRESS4={{INVOICEADDRESS4}}&INVOICEPHONE={{INVOICEPHONE}}&DELIVERPHONE={{INVOICEPHONE}}&INVOICEEMAIL={{INVOICEEMAIL}}&DELIVEREMAIL={{INVOICEEMAIL}}&INVOICEEMAIL_CONFIRM={{INVOICEEMAIL}}&DELIVEREMAIL_CONFIRM={{INVOICEEMAIL}}&INVOICEUSERDEFINED={{INVOICEUSERDEFINED}}&ACTION_NEXT.x=87&ACTION_NEXT.y=12")
            {
                datarow.newrow("Parameters", "RANDOM=0.346205551018105&SEQUENCE=0&ActCheckoutPhase=INVOICE&ActCheckoutPhase=DELIVER&ActCheckoutPhase=PRELIM&INVOICENAME={{FirstName}}+{{LastName}}&DELIVERNAME={{FirstName}}+{{LastName}}&INVOICEPOSTALCODE={{INVOICEPOSTALCODE}}&DELIVERPOSTALCODE={{INVOICEPOSTALCODE}}&INVOICEADDRESS1={{INVOICEADDRESS1}}&DELIVERADDRESS1={{INVOICEADDRESS1}}&INVOICEADDRESS2={{INVOICEADDRESS2}}&DELIVERADDRESS2={{INVOICEADDRESS2}}&INVOICEADDRESS3={{INVOICEADDRESS3}}&DELIVERADDRESS3={{INVOICEADDRESS3}}&LocationInvoiceCountry={{INVOICECOUNTRY}}&INVOICECOUNTRY={{INVOICECOUNTRY}}&LocationDeliveryCountry={{INVOICECOUNTRY}}&LocationInvoiceRegion=UndefinedRegion&INVOICEADDRESS4={{INVOICEADDRESS4}}&LocationDeliveryRegion=UndefinedRegion&DELIVERADDRESS4={{INVOICEADDRESS4}}&INVOICEPHONE={{INVOICEPHONE}}&DELIVERPHONE={{INVOICEPHONE}}&INVOICEEMAIL={{INVOICEEMAIL}}&DELIVEREMAIL={{INVOICEEMAIL}}&INVOICEEMAIL_CONFIRM={{INVOICEEMAIL}}&DELIVEREMAIL_CONFIRM={{INVOICEEMAIL}}&INVOICEUSERDEFINED={{INVOICEUSERDEFINED}}&ACTION_NEXT.x=87&ACTION_NEXT.y=12", str6, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("Parameters", "RANDOM=0.346205551018105&SEQUENCE=0&ActCheckoutPhase=INVOICE&ActCheckoutPhase=DELIVER&ActCheckoutPhase=PRELIM&INVOICENAME={{FirstName}}+{{LastName}}&DELIVERNAME={{FirstName}}+{{LastName}}&INVOICEPOSTALCODE={{INVOICEPOSTALCODE}}&DELIVERPOSTALCODE={{INVOICEPOSTALCODE}}&INVOICEADDRESS1={{INVOICEADDRESS1}}&DELIVERADDRESS1={{INVOICEADDRESS1}}&INVOICEADDRESS2={{INVOICEADDRESS2}}&DELIVERADDRESS2={{INVOICEADDRESS2}}&INVOICEADDRESS3={{INVOICEADDRESS3}}&DELIVERADDRESS3={{INVOICEADDRESS3}}&LocationInvoiceCountry={{INVOICECOUNTRY}}&INVOICECOUNTRY={{INVOICECOUNTRY}}&LocationDeliveryCountry={{INVOICECOUNTRY}}&LocationInvoiceRegion=UndefinedRegion&INVOICEADDRESS4={{INVOICEADDRESS4}}&LocationDeliveryRegion=UndefinedRegion&DELIVERADDRESS4={{INVOICEADDRESS4}}&INVOICEPHONE={{INVOICEPHONE}}&DELIVERPHONE={{INVOICEPHONE}}&INVOICEEMAIL={{INVOICEEMAIL}}&DELIVEREMAIL={{INVOICEEMAIL}}&INVOICEEMAIL_CONFIRM={{INVOICEEMAIL}}&DELIVEREMAIL_CONFIRM={{INVOICEEMAIL}}&INVOICEUSERDEFINED={{INVOICEUSERDEFINED}}&ACTION_NEXT.x=87&ACTION_NEXT.y=12", str6, "FAIL", driver, selenium);
            }
            ...
            {
                datarow.newrow("Address Equation2", "#idBothAddressesTable tr:eq(5) td:eq(0)", str23, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("Address Equation2", "#idBothAddressesTable tr:eq(5) td:eq(0)", str23, "FAIL", driver, selenium);
            }
            ...
            {
                datarow.newrow("Country Eqaution", "#idBothAddressesTable tr:eq(7) td:eq(0)", str29, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("Country Eqaution", "#idBothAddressesTable tr:eq(7) td:eq(0)", str29, "FAIL", driver, selenium);
            }
            ...
            string str31 = driver.FindElement(By.Id("LiveScrapeForm_Elements_6__KeysValuesSelector")).GetAttribute("Value");
            ...
            if (driver.FindElement(By.Id("LiveScrapeForm_Elements_7__LabelSelector")).GetAttribute("Value") == "#idBothAddressesTable tr:eq(8) td:eq(0)")
            {
                datarow.newrow("County Equation", "#idBothAddressesTable tr:eq(8) td:eq(0)", str29, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("County Equation", "#idBothAddressesTable tr:eq(8) td:eq(0)", str29, "FAIL", driver, selenium);
            }
            ...
            {
                datarow.newrow("Phone Equation", "#idBothAddressesTable tr:eq(9) td:eq(0)", str36, "PASS", driver, selenium);
            }
            else
            {
                datarow.newrow("Phone Equation", "#idBothAddressesTable tr:eq(9) td:eq(0)", str36, "FAIL", driver, selenium);
            }
