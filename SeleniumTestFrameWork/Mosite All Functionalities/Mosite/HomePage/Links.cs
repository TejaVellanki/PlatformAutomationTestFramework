                    ...
                    for (int k = 1;; k++)
                    {
                        try
                        {
                            if (selenium.IsElementPresent("//html/body/div/div[2]/div/ul/li[" + k + "]/div/div/a/h2"))
                            {
                                ...
                                driver.FindElement(By.XPath("//html/body/div/div[2]/div/ul/li[" + k + "]/div/div/a/h2"))
                                      .Click();
                                selenium.WaitForPageToLoad("30000");
                                ...
                                else
                                {
                                    try
                                    {
                                        ...
                                        if (
                                            selenium.IsElementPresent(
                                                "//body[@id='page-products-details']/div/div[2]/div/div/div/p/strong"))
                                        {
                                            string price =
                                                driver.FindElement(
                                                    By.XPath(
                                        ...
                                        if (selenium.IsElementPresent("id=Variants_0__OptionValue"))
                                        {
                                            ...
                                            {
                                                string[] varinats =
                                                    selenium.GetSelectOptions("id=Variants_0__OptionValue");
                                                string values = null;
                                                foreach (string value in varinats)
                                                {
                                                    if (value != "Please Select")
                                                    {
                                                        values = values + "\r\n" + value;
                                                        new SelectElement(
                                                            driver.FindElement(By.Id("Variants_0__OptionValue")))
                                                            .SelectByText(value);
                                                    }
                                                }
                                    ...
                                    {
                                        string e = ex.ToString();
                                        datarow.newrow("Exception For Product Details", "Exception Not Expected", e,
