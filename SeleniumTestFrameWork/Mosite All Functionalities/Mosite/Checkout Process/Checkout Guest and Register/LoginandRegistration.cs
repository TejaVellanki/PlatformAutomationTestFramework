    ...
    internal class LoginandRegistration_TPS :driverdefining
    {
        ...
        public void Login_TPS(IWebDriver driver, datarow datarow)
        {
            ...
            try
            {
                ...
                if (IsElementPresent(driver,By.XPath("//html/body/div/div[2]/div[2]/form/section/p/a/span/span/span/span"),30))
                {
                   ...
                   driver.FindElement(By.XPath("//html/body/div/div[2]/div[2]/form/section/p/a/span/span/span/span")).Click();
                    ...
                    try
                    {
                        ...
                        {
                            if (IsElementPresent(driver,By.XPath("//form[@id='ctl00']/section/div[" + i + "]/label"),30))
                            {
                                string valuet =
                                ...
                                if (valuet == "Country: *")
                                {
                                    ...
                                    {
                                        values = values + "\r\n" + value;
                                        new SelectElement(driver.FindElement(By.Id("Pagecontent_ddlCountry"))).SelectByText(value.Text);
                                    }
                ...
                try
                {
                    if (IsElementPresent(driver,By.XPath("//html/body/div/div[2]/div[2]/form/section/div[2]/fieldset/div/label/span/span"),30))
                    {
                        decimal count =
                        ...
                        for (int i = 1; i < count; i++)
                        {
                            string text =driver.FindElement(By.XPath("//html/body/div/div[2]/div[2]/form/section/div[2]/fieldset/div[" + i +"]/label/span/span")).Text;
                            driver.FindElement(By.XPath("//html/body/div/div[2]/div[2]/form/section/div[2]/fieldset/div[" + i +"]/label/span/span")).Click();
