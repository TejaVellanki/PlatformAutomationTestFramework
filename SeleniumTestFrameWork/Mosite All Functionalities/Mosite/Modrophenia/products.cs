...
namespace MoBankUI
{
    ...
    internal class products
    {
        ...
        {
            this.gereneralLibrary = new GeneralLibrary();
            DataTable table = this.gereneralLibrary.GetExcelData(@"C:\Selenium\Input Data\ModrophenialiveProducts.xlsx", "Products").Tables[0];
        ...
        public void product(datarow datarow, IWebDriver driver, ISelenium selenium)
        {
            ...
            try
            {
                ...
                driver.FindElement(By.XPath("//body[@id='page-home-index']/div/div[2]/div/ul/li[1]/div/div/a/h2")).Click();
            ...
            Label_0099:
                ...
                for (int i = 1; i <= xpathCount; i++)
                {
                    ...
                    string str5;
                    string str7;
                    driver.FindElement(By.XPath("//body[@id='page-categories-details']/div/div[2]/div/ul/li[" + i + "]/div/div/a")).Click();
                    selenium.WaitForPageToLoad("60000");
                        ...
                        {                               
                            if (selenium.GetXpathCount("//html/body/div/div[2]/div/div[3]/form/ul/li[2]/fieldset/div[2]/div/label/span") != 1)
                            {
                                ...
                                foreach (string str6 in selectOptions)
                                {
                                    ...
                                    {
                                        str5 = str5 + "\r\n" + str6;
                                        new SelectElement(driver.FindElement(By.Id("Variants_0__OptionValue"))).SelectByText(str6);
                                    }
                                }
                                row[4] = str5;
                                }
